//// -----------------------------------------------------------------------
//// <copyright file="TimingHtmlValidatorUrlProcessorForXmlOutput.cs" company="">
...
//    /// TODO: Update summary.
//    /// </summary>
//    public class TimingUrlProcessor : UrlProcessor
//    {
//        protected readonly IRunnerContext mContext;
//        protected readonly UrlProcessor mProcessor;
...
//        protected override IValidatorReportItem ValidateUrl(string url, IValidatorReportTextWriter writer, string outputPath)
//        {
//            mStopwatch.Reset();
//            mStopwatch.Start();

//            var result = mProcessor.ValidateUrl(url, writer, outputPath);
